...
// prepare expected items for insertion into database
      ...
      $sql = "UPDATE answers SET assess = '$assess', scale = '$scale'
...
<td>
<input type="text" name="firstname" id="firstname" value="<?php echo htmlentities($row['first_name']); ?>" />
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" name="lastname" id="lastname" value="<?php echo htmlentities($row['last_name']); ?>" />
</td>
</tr>
-->
<tr>
...
<tr>
<td><input type="submit" name="update" id="button" value="update" class="move" /></td>
